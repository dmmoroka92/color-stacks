...
function Cylinder({ color }: CylinderProps) {
  return (
    <div
      className={[
    ...
    >
      ...
      <div className="absolute left-1/2 top-1 z-10 h-3 w-4 -translate-x-1/2
        rounded-[50%] bg-slate-800/70" />

      <div className="absolute left-1/2 top-[6px] z-20 h-[6px] w-[10px] -translate-x-1/2
